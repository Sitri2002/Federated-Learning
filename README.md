...
For smaller file sizes, mimic-cxr-labeled.csv was deleted from the respective FLOWER and FedML folders. Put copy it from baseline and put it in data for FLOWER and data_cache for FedML to run.\
